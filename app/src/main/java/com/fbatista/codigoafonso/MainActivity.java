...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (String item : listaDePalavras) {
        ...
        System.out.println("Quantidade de verbos " + contVerbo);
        System.out.println("Quantidade de verbos em primeira pessoa " + contVerboPrimeiraPessoa);
        System.out.println("Quantidade de preposições " + contPreposicao);
    }
}
